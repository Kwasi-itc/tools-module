...
TOOLS_DATA: List[Dict] = [
    ...
    {
        "name": "web_search",
        "description": "Perform live web searches using the DuckDuckGo instant answer API.",
        "type": ToolType.HTTP,
        "version": "1.0.1",
        "tool_metadata": {
            "category": "utility",
        ...
        "parameters": [
            {
                ...
                "type": "string",
                "required": True,
                "description": "Search query string forwarded to DuckDuckGo.",
                "parameter_type": ParameterType.INPUT,
            },
            {
                "name": "results",
                "type": "array",
                "required": False,
                "description": "List of search results returned by the API (RelatedTopics field).",
                "parameter_type": ParameterType.OUTPUT,
            },
        ],
        "configs": [
            {"config_key": "base_url", "config_value": "https://api.duckduckgo.com"},
            {"config_key": "endpoint", "config_value": "/"},
            {"config_key": "method", "config_value": "GET"},
            {"config_key": "headers", "config_value": json.dumps({"Accept": "application/json"})},
            {"config_key": "query_params", "config_value": json.dumps({"format": "json", "no_redirect": 1})},
        ],
        "rate_limits": [
            {"scope": RateLimitScope.GLOBAL, "max_requests": 5000, "time_window_seconds": 3600},
    ...
    },
    {
        ...
        "tool_metadata": {
            "category": "utility",
            "provider": "Tavily",
            "tags": ["web", "search", "research", "ai-search", "pre-configured"],
        },
        "parameters": [
            {
                "name": "query",
...
PERMISSIONS_DATA = [
    ...
    {"role": "platform-admin", "tool": "tavily_search_configured", "action": PermissionAction.MANAGE},
    ...
    {"role": "fintech-analyst", "tool": "tavily_search_configured", "action": PermissionAction.EXECUTE},
    ...
    {"role": "customer-support", "tool": "tavily_search_configured", "action": PermissionAction.READ},
